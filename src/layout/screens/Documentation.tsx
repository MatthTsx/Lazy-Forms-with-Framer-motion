...
function Documentation({...p} : CommonPDataPlus) {
  ...
  return (
    <motion.div className='fixed h-screen w-screen flex items-center justify-center z-10'
        style={{
            display: useTransform(smooth, [k(120),k(105), k(99), k(-10), k(-20)], ["none", "none", "flex", "flex", "none"]),
            scale: useTransform(smooth, [k(105), k(90)], ["5", "1"]),
            top: useTransform(smooth, [k(105), k(90)], ["60%", "0%"]),
            right: useTransform(smooth, [k(105), k(90)], ["75%", "0%"]),
            opacity: useTransform(smooth, [k(10), k(-10)], [1, 0])
        }}>
      ...
      <motion.div className='bg-orange-400 w-[10%] aspect-square absolute right-[30%] drop-shadow-2xl top-[30%] shadow-md flex justify-center rounded-sm' style={{
        scale: useTransform(smooth, [k(105), k(90)], ["5", "1"]),
        rotate: useTransform(smooth, [k(105), k(90)], ["0deg", "10deg"])
      }}>
